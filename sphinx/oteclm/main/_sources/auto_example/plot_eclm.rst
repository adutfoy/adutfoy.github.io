...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    Best model PSG( 0 |n) :  LogNormal(muLog = -25.183, sigmaLog = 3.3655e-05, gamma = 1) p-value =  0.052894627238650564
    Best model PES( 0 |n) :  Gamma(k = 40807, lambda = 4.11906e+06, gamma = 0.987842) p-value =  0.7044145873320538
    Best model PTS( 0 |n) :  LogNormal(muLog = -26.1717, sigmaLog = 9.57701e-05, gamma = 1) p-value =  0.3044564764681383

    Test de Lilliefors
    ==================

    Ordre k= 1
    Best model PEG( 1 |n) :  Beta(alpha = 2.36507, beta = 2.90073, a = 0.000270467, b = 0.000304859) p-value =  0.43501218521527213
    Best model PSG( 1 |n) :  Beta(alpha = 2.0922, beta = 2.36032, a = 0.000351093, b = 0.000392658) p-value =  0.6459808413161183
    Best model PES( 1 |n) :  Beta(alpha = 2.36507, beta = 2.90073, a = 0.00189327, b = 0.00213401) p-value =  0.44556859571023877
    Best model PTS( 1 |n) :  LogNormal(muLog = -6.07755, sigmaLog = 0.0212681, gamma = -4.35886e-05) p-value =  0.5733706517393042

    Test de Lilliefors
    ==================

    Ordre k= 2
    Best model PEG( 2 |n) :  LogNormal(muLog = -12.1143, sigmaLog = 0.0954646, gamma = 2.75555e-06) p-value =  0.5729708116753298
    Best model PSG( 2 |n) :  LogNormal(muLog = -3.31443, sigmaLog = 5.79089e-05, gamma = -0.0363328) p-value =  0.12663755458515283
    Best model PES( 2 |n) :  LogNormal(muLog = -9.06982, sigmaLog = 0.0954646, gamma = 5.78665e-05) p-value =  0.562322371092164
    Best model PTS( 2 |n) :  LogNormal(muLog = -8.35387, sigmaLog = 0.0690542, gamma = 1.32684e-05) p-value =  0.15360983102918588

    Test de Lilliefors
    ==================

    Ordre k= 3
    Best model PEG( 3 |n) :  LogNormal(muLog = -6.1013, sigmaLog = 6.68739e-05, gamma = -0.00223825) p-value =  0.1008991008991009
    Best model PSG( 3 |n) :  Beta(alpha = 1.20877, beta = 1.77767, a = 2.77205e-06, b = 5.79554e-06) p-value =  0.008991008991008992
    Best model PES( 3 |n) :  LogNormal(muLog = -1.72231, sigmaLog = 2.93466e-05, gamma = -0.178592) p-value =  0.11857142857142858
    Best model PTS( 3 |n) :  Beta(alpha = 1.46728, beta = 1.42126, a = 5.86288e-05, b = 9.25024e-05) p-value =  0.11430356027482823

    Test de Lilliefors
    ==================

    Ordre k= 4
    Best model PEG( 4 |n) :  Beta(alpha = 1.1208, beta = 1.57229, a = 2.63157e-07, b = 5.70431e-07) p-value =  0.002997002997002997
    Best model PSG( 4 |n) :  Beta(alpha = 0.958575, beta = 2.08678, a = 4.42352e-07, b = 1.53262e-06) p-value =  0.014985014985014986
    Best model PES( 4 |n) :  Beta(alpha = 1.1208, beta = 1.57229, a = 9.2105e-06, b = 1.99651e-05) p-value =  0.003996003996003996
    Best model PTS( 4 |n) :  Beta(alpha = 1.0647, beta = 1.66919, a = 1.03286e-05, b = 2.48565e-05) p-value =  0.011988011988011988

    Test de Lilliefors
    ==================

    Ordre k= 5
    Best model PEG( 5 |n) :  Beta(alpha = 0.89003, beta = 1.99864, a = 4.96753e-08, b = 2.1129e-07) p-value =  0.016983016983016984
    Best model PSG( 5 |n) :  Beta(alpha = 0.81495, beta = 2.37197, a = 6.86841e-08, b = 4.52224e-07) p-value =  0.10789210789210789
    Best model PES( 5 |n) :  Beta(alpha = 0.89003, beta = 1.99864, a = 1.04318e-06, b = 4.43709e-06) p-value =  0.012987012987012988
    Best model PTS( 5 |n) :  Beta(alpha = 0.87676, beta = 2.09542, a = 1.10635e-06, b = 5.15319e-06) p-value =  0.022977022977022976
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** ( 0 minutes  58.668 seconds)
