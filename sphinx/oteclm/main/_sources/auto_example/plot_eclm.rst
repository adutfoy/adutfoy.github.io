...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    Best model PSG( 0 |n) :  LogNormal(muLog = -25.5838, sigmaLog = 5.02538e-05, gamma = 1) p-value =  0.03396603396603397
    Best model PES( 0 |n) :  Gamma(k = 40807, lambda = 4.11906e+06, gamma = 0.987842) p-value =  0.7049024274155165
    Best model PTS( 0 |n) :  LogNormal(muLog = -26.6129, sigmaLog = 0.000148879, gamma = 1) p-value =  0.3198720511795282

    Test de Lilliefors
    ==================

    Ordre k= 1
    Best model PEG( 1 |n) :  Beta(alpha = 2.36507, beta = 2.90073, a = 0.000270467, b = 0.000304859) p-value =  0.41361043194784025
    Best model PSG( 1 |n) :  Beta(alpha = 2.0922, beta = 2.36032, a = 0.000351093, b = 0.000392658) p-value =  0.6603019538188277
    Best model PES( 1 |n) :  Beta(alpha = 2.36507, beta = 2.90073, a = 0.00189327, b = 0.00213401) p-value =  0.43554290361935744
    Best model PTS( 1 |n) :  LogNormal(muLog = -6.07755, sigmaLog = 0.0212681, gamma = -4.35885e-05) p-value =  0.5795734208367515

    Test de Lilliefors
    ==================

    Ordre k= 2
    Best model PEG( 2 |n) :  LogNormal(muLog = -12.1143, sigmaLog = 0.0954646, gamma = 2.75555e-06) p-value =  0.557131280388979
    Best model PSG( 2 |n) :  LogNormal(muLog = 0.151186, sigmaLog = 1.80986e-06, gamma = -1.16319) p-value =  0.11287128712871287
    Best model PES( 2 |n) :  LogNormal(muLog = -9.06982, sigmaLog = 0.0954646, gamma = 5.78665e-05) p-value =  0.5565006075334142
    Best model PTS( 2 |n) :  LogNormal(muLog = -8.35387, sigmaLog = 0.0690542, gamma = 1.32684e-05) p-value =  0.1655215490318551

    Test de Lilliefors
    ==================

    Ordre k= 3
    Best model PEG( 3 |n) :  LogNormal(muLog = -6.53392, sigmaLog = 0.000103073, gamma = -0.00145158) p-value =  0.11619047619047619
    Best model PSG( 3 |n) :  Beta(alpha = 1.20877, beta = 1.77767, a = 2.77205e-06, b = 5.79554e-06) p-value =  0.012987012987012988
    Best model PES( 3 |n) :  LogNormal(muLog = -2.02331, sigmaLog = 3.9653e-05, gamma = -0.132158) p-value =  0.11661807580174927
    Best model PTS( 3 |n) :  Beta(alpha = 1.46728, beta = 1.42126, a = 5.86288e-05, b = 9.25024e-05) p-value =  0.1068931068931069

    Test de Lilliefors
    ==================

    Ordre k= 4
    Best model PEG( 4 |n) :  Beta(alpha = 1.1208, beta = 1.57229, a = 2.63157e-07, b = 5.70431e-07) p-value =  0.000999000999000999
    Best model PSG( 4 |n) :  Beta(alpha = 0.958575, beta = 2.08678, a = 4.42352e-07, b = 1.53262e-06) p-value =  0.013986013986013986
    Best model PES( 4 |n) :  Beta(alpha = 1.1208, beta = 1.57229, a = 9.2105e-06, b = 1.99651e-05) p-value =  0.001998001998001998
    Best model PTS( 4 |n) :  Beta(alpha = 1.0647, beta = 1.66919, a = 1.03286e-05, b = 2.48565e-05) p-value =  0.007992007992007992

    Test de Lilliefors
    ==================

    Ordre k= 5
    Best model PEG( 5 |n) :  Beta(alpha = 0.89003, beta = 1.99864, a = 4.96753e-08, b = 2.1129e-07) p-value =  0.015984015984015984
    Best model PSG( 5 |n) :  Beta(alpha = 0.81495, beta = 2.37197, a = 6.86841e-08, b = 4.52224e-07) p-value =  0.10589410589410589
    Best model PES( 5 |n) :  Beta(alpha = 0.89003, beta = 1.99864, a = 1.04318e-06, b = 4.43709e-06) p-value =  0.014985014985014986
    Best model PTS( 5 |n) :  Beta(alpha = 0.87676, beta = 2.09542, a = 1.10635e-06, b = 5.15319e-06) p-value =  0.015984015984015984
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** ( 0 minutes  54.348 seconds)
